...
function AddDoctor() {
  ...
  return (
        <form onSubmit={onSubmitHandler} className='m-5 w-full'>
            ...
            <div className='bg-white px-8 py-8 border rounder w-full max-w-[100vh] max-h-[80vh] overflow-y-scroll '>
                ...
                <div className='flex flex-col lg:flex-row items-start gap-10 text-gray-600'>
                    <div className='w-full lg:flex-1 flex flex-col gap-4'>
                        ...
                        <div className='flex-1 flex flex-col gap-1'>
                         ...
                         <div className='flex-1 flex flex-col gap-1'>
                            <p> Doctor Fees </p>
                            <input onChange={(e)=>setFees(e.target.value)} value={fees} className='border rounded px-3 py-2 border-gray-400' type="number" placeholder='Fee' required/>
                        </div>
                    </div>
                ...
                <div>
                            ...
                            <textarea onChange={(e)=>setAbout(e.target.value)} value={about} className='w-full px-4 pt-2 border rounded border-gray-400' type="text" placeholder='Write about doctor' rows={5} required/>
                        </div>

                        <button type="submit" className='bg-[#5F3FFF] px-10 py-3 mt-4 text-white rounded-full'> Add Doctor </button>
